...
![almav Mapa Interativo](https://raw.githubusercontent.com/almav/urba.almav.com.br-smarturbaesmeraldas/main/assets/images/screen02.png)
...
```html
    ...
    <script
        src="https://maps.app.almav.com/apiv1/js/almav-initmap.js?key=aaf34aea-e749-4adf-a7a7-04dfd1f8899b&callback=initMap"
        defer></script>
```
